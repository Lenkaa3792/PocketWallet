...
import 'package:mobilebank/pages/dashboard.dart'; // Ensure this path is correct
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.teal, // Changed color to teal
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
                height:
                    16), // Adding space between the text and the input fields
            TextField(
              style: TextStyle(
                  color:
            ...
            SizedBox(
                height:
                    12), // Adding space above the "Forgot your password?" link
            Row(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                onPrimary: Colors.teal, // Set text color to teal
              ),
              child: Text('Sign In'),
            ),
          ],
